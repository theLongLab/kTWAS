...
//        bw.write(ss+"\n");
        ...
        bw.write(ss+"\n");
        ss="write(ss ,\""+out_folder+"kTWAS.result\")";
        bw.write(ss+"\n");
        bw.close();
	}
...
//					ss_eqtl= rs_dict.get(pos)+"\t1.0";
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		if(args.length==0){
			System.out.println("kTWAS: integrating kernel-machine with transcriptome-wide association "
					+ "studies improves statistical power and reveals novel genes.\n Usage:\n"
					+ "-format csv|plink\n"
		...
		if(args[0].equals("pvalue-lm")){
			...
			if(args.length < 14){
				System.out.println("kTWAS: integrating kernel-machine with transcriptome-wide "
						+ "association studies improves statistical power and reveals novel genes.\n Usage:\n"
						+ "-format csv|plink\n"
						+ "-input_genotype INPUT_GENOTYPE_FILE\n"
						+ "-input_phenotype INPUT_PHENOTYPE_FILE\n"
						+ "-input_phenotype_column INPUT_PHENOTYPE_COLUMN_START:2\n"
